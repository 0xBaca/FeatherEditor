...
{
    struct RemoveUntilFileEndActionInput
    {
        ...
        RemoveUntilFileEndActionInput(utils::datatypes::Uuid const &, std::shared_ptr<windows::WindowsManager>, pair, std::shared_ptr<utils::storage::AbstractStorage>, std::shared_ptr<feather::printer::PrintingOrchestratorInterface>);
    };
} // namespace feather::action
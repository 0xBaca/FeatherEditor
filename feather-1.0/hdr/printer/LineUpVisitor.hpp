...
{
  class LineUpVisitor : public PrintingVisitorInterface, protected WindowStatus
  {
    std::shared_ptr<printer::PrintingOrchestratorInterface> printingOrchestrator;

  public:
    LineUpVisitor() = default;
    LineUpVisitor(std::shared_ptr<printer::PrintingOrchestratorInterface>);

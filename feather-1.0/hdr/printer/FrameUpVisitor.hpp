...
{
  class FrameUpVisitor : public PrintingVisitorInterface, protected WindowStatus
  {
    std::shared_ptr<printer::PrintingOrchestratorInterface> printingOrchestrator;

  public:
    FrameUpVisitor() = default;
    FrameUpVisitor(std::shared_ptr<printer::PrintingOrchestratorInterface>);

...
{
    class HalfFrameDownVisitor : public PrintingVisitorInterface, protected WindowStatus
    {
        std::shared_ptr<printer::PrintingOrchestratorInterface> printingOrchestrator;

    public:
        HalfFrameDownVisitor() = default;
        HalfFrameDownVisitor(std::shared_ptr<printer::PrintingOrchestratorInterface>);

...
{
  class CurrFrameVisitor : public PrintingVisitorInterface, protected WindowStatus
  {
    std::shared_ptr<printer::PrintingOrchestratorInterface> printingOrchestrator;

  public:
    CurrFrameVisitor() = default;
    CurrFrameVisitor(std::shared_ptr<printer::PrintingOrchestratorInterface>);

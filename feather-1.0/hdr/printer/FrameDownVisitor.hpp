...
{
class FrameDownVisitor : public PrintingVisitorInterface, protected WindowStatus
{
  std::shared_ptr<printer::PrintingOrchestratorInterface> printingOrchestrator;

public:
  FrameDownVisitor() = default;
  FrameDownVisitor(std::shared_ptr<printer::PrintingOrchestratorInterface>);
